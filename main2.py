...
def func_cell(self, combination, order_of_nei):
    ...
    if self.num in combination:
        ...
        aaa = order_of_nei[i].num / 10 * (self.num + 1)
...
def print_all_comb_weights(all_agents):
    ...
    for i in itertools.product(*list_of_domains):
        res = cell3.func(cell3, i, order_of_nei) + cell4.func(cell4, i, order_of_nei) + cell5.func(cell5, i, order_of_nei)
        if res > 0:
            res = res
...
def scenario_11():
    ...
    cell8.neighbours = [robot1]
    cell9.neighbours = [robot2]
    robot1.neighbours = [cell1, cell2, target1, cell8, ]  # cell8,
    robot2.neighbours = [cell1, cell2, target1, cell9]  # cell9,
...
def main():
    ...
    for iteration in range(ITERATIONS):
        ...
        collisions.append(print_table_of_messages(all_agents, iteration))
    print(f'collisions: {sum(collisions[-10:])}')

    # print_all_comb_weights(all_agents)
    # print_all_pos_sum_weights(all_agents)
